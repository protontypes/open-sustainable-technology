...
- [AMS Reader](https://github.com/UtilitechAS/amsreader-firmware) - Designed to decode data from electric smart meters installed in many countries in Europe these days.
