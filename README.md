...
- [plant](https://github.com/traitecoevo/plant) - Extensible framework for modelling size- and trait-structured demography, ecology and evolution in simulated forests.
