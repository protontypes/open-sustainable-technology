...
- [RAMP](https://github.com/RAMP-project/RAMP) - is a bottom-up stochastic model for the generation of high-resolution multi-energy profiles, conceived for application in contexts where only rough information about users' behaviour are obtainable.
...
- [Technical University of Denmark Wind Energy](https://gitlab.windenergy.dtu.dk/explore) 
