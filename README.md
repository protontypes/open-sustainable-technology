...
If you want to get started with topics like renewable energy, climate change, or Earth science, check out the collection of tutorials in the [educational section](https://opensustain.tech/education/). 
...
- [weather-maker](https://github.com/bje-/weather-maker) - Generate TMY3 or EPW format files from Australian Bureau of Meteorology weather and solar radiation data.
