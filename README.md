...
### Wind Energy
- [DSWE](https://github.com/TAMU-AML/DSWE-Package) - An R implementation of various data science methods for wind energy (DSWE) applications. One of the primary goals of this package is to provide leading machine learning methods for accurately estimating the wind power curve.
